            ...
            <div className="grid md:grid-cols-2 gap-5">
              ...
              <div className="card h-fit max-w-6xl" id="form">
                ...
                <form action="#" className="space-y-8">
                  <div>
                    <label for="email" className="block mb-2 text-sm font-medium text-[#433a33] ">
                      Your email
                    </label>
                    <input
                      type="email"
                  ...
                  <div>
                    <label for="subject" className="block mb-2 text-sm font-medium text-[#433a33] ">
                      Subject
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="sm:col-span-2">
                    <label for="message" className="block mb-2 text-sm font-medium text-[#433a33] ">
                      Your message
                    </label>
                    <textarea
                      id="message"
